...
DSJsonApiAdapter = require('./js-data-jsonapi');

store = new JSData.DS();
store.registerAdapter('jsonapi', new DSJsonApiAdapter({
    basePath: 'http://127.0.0.1:10010/api',
}), { default: true });

orders = store.defineResource({
    name: 'orders',
    adapter: 'jsonapi',
    relations: {
        belongsTo: {
...
orders.find(1).then(function(data){
    console.log('success', data);
}, function(err){
    console.log('error', err);
});

},{"./js-data-jsonapi":2,"js-data":4,"js-data-http":3}],2:[function(require,module,exports){
...
function deserializeData(data){
    ...
    if(data.relationships){
        _.forEach(data.relationships, function(value, key){
...
function deserialize(resourceConfig, response){

    if(_.has(response, 'data.include')){
        // Add the include data first
        [].concat(response.data.include).map( injectInclude );
    }

    var resourceData;
    if(_.has(response, 'data.data')){
        // Add the include data first
        resourceData = [].concat(response.data.data).map( deserializeData );
    }
...
},{"js-data-http":3,"lodash":5}],3:[function(require,module,exports){
/*!
 * js-data-http
...
;
},{"js-data":4}],4:[function(require,module,exports){
/*!
 * js-data
